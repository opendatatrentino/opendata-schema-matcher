...
/**
 * Implementation of the schema matcher. The schema matcher uses
 * Column-ConceptRecognizer that extracts concepts from the headers of schema
 * elements (from names and instances of schema element),
 *
...
public class SimpleSchemaMatcher implements ISchemaMatcher {
    ...
    /**
     * Methods computes scores from schema names concepts and element
    ...
    /**
     * Methods returns score based on the distance between two source and target
     * concepts of schemas names
     *
     * @param sourceSchema
     * @param targetSchema
