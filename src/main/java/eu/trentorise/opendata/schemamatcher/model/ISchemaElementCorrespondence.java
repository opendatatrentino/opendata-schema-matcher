...
public interface ISchemaElementCorrespondence {
    ...
    /**
     * Methods returns the correspondence score between target and source schema
     * element from min to max - [0,1],
     *
    ...
    /**
     * Method allows to set scores that represents similarity between source and
     * target elements. Score is in the interval [0,1], where maximum and
     * minimum similarities are '1' and '0' accordingly.
     *
     * @param score
     */
    ...
    /**
     * Method allows to get a correspondence of a source element to all the
     * target elements with scores.
     *
