...
public interface ISchemaElementMatcher {
     ...
     *
     * @param sourceSchemaElement is a schema element FROM which matching is
     * required
     * @param targetSchemaElement is a schema element TO which matching is
     * required
     * @param elementMatchingAlgorithm algorithm that is used for schema
     * matching
    ...
    /**
     * Match the list of elements and returns matching score for a matched pairs
     * of elements
     *
     * @param sourceElements the list of schema elements FROM which mapping is
     * required
     * @param targetElements the list of schema elements TO which mapping is
     * required
     * @return list of coresspondences between given lists of schemas and
     * mapping among their elements.
     */
    ...
    /**
     * Returns the name of an algorithm used for matching elements.
     *
