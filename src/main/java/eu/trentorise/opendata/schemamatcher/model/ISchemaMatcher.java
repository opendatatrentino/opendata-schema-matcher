...
public interface ISchemaMatcher {
    ...
    /**
     * Match two schemas and returns matching score and mapping among elements
     * of given schemas
     *
     ...
     * @return coresspondence between two schemas and mapping among their
     * elements.
     */
    ...
    /**
     * Match the list of schemas and returns matching score and mapping among
     * elements of given schemas
     *
     ...
     * matching
     * @return coresspondence between all schemas and mapping among their
     * elements.
     */
