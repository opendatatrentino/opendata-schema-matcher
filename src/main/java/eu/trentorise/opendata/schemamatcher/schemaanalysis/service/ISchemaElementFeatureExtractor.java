...
public interface ISchemaElementFeatureExtractor {
	...
	/** Method extracts a concept(s) from schema element and assigns it to the given element 
	 * @param schemaElement schema element
	 */
	void getSchemaElementConcept( ISchemaElement schemaElement);
	
	/** Method extracts a concept(s) from schema elements and assigns it to the given elements correspondingly 
